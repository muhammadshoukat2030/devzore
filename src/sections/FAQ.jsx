...
const FAQ = ({ isDark }) => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Our pricing depends on the project scope, complexity and timeline. We provide fixed-price proposals after a free discovery call — no hourly billing surprises. A business website starts from $800. A custom web application starts from $3,000. A full SaaS platform starts from $8,000. A mobile app starts from $5,000. All prices include UI/UX design, development, testing, deployment and 30 days of post-launch support. Contact us for a free detailed quote.',
      keywords: 'software development cost Pakistan, web development pricing, how much does web development cost',
    },
    {
      category: 'Services',
    ...
    },
    {
      ...
      answer: 'We offer fixed-price project proposals for defined scopes. After a free discovery call, we produce a detailed proposal with a fixed price tied to specific deliverables and milestones. This protects you from billing surprises and gives us a clear shared understanding of the project. For ongoing retainer work — such as maintenance, feature additions or scaling — we offer monthly retainer plans starting from $300 per month.',
      keywords: 'fixed price web development, software development pricing Pakistan, project cost estimate',
    },
    {
      category: 'Support',
            ...
            >
              ...
              >
                <div className="flex items-start gap-3">
                  {/* Category badge */}
                  <span className={`flex-shrink-0 mt-0.5 text-[9px] font-bold px-2 py-1 rounded-full ${
                    activeIndex === i
                ...
                {/* Toggle icon */}
                <div className={`flex-shrink-0 w-7 h-7 rounded-lg flex items-center justify-center transition-all duration-200 mt-0.5 ${
                  activeIndex === i
              ...
              <div className={`transition-all duration-300 overflow-hidden ${
                activeIndex === i ? 'max-h-[400px] opacity-100' : 'max-h-0 opacity-0'
              }`}>
                <div className={`px-5 pb-5 pt-0 border-t ${
                  d ? 'border-white/[0.06]' : 'border-purple-100'
                }`}>
