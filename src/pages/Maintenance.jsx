  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-purple-500/30 pb-20 overflow-x-hidden">
      ...
      <Helmet>
        ...
        <meta property="og:description" content="Professional website maintenance — bug fixes, security patches, performance tuning and ongoing support from DevZore, Islamabad." />
        ...
        <meta name="twitter:description" content="DevZore provides professional website maintenance and support — bug fixes, security updates, performance monitoring, and feature additions." />
