...
const Footer = () => {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
            ...
            <div>
              ...
              <ul className="space-y-1.5">
                {[
                  ...
                  { name: "MERN Stack", path: "/mern-stack-development" },
                  ...
                  <li key={srv.path}>
                    <Link 
                      ...
                      className="text-gray-400 hover:text-purple-400 transition text-xs font-medium"
                    >
                      {srv.name}
                    </Link>
                  </li>
          ...
          <div className="pt-6 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-wrap justify-center items-center gap-6 text-[9px] font-bold uppercase tracking-widest text-gray-500">
              <Link to="/privacy-policy" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-purple-500 transition-colors">Privacy Policy</Link>
              <Link to="/terms-and-conditions" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-purple-500 transition-colors">Terms & Conditions</Link>
              
              <button
                onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
                className="text-white hover:text-purple-800 transition-all flex items-center justify-center bg-white/5 border border-white/10 w-7 h-7 rounded-lg text-sm font-normal"
      ...
      <div className="fixed bottom-5 right-5 sm:bottom-6 sm:right-6 z-[9999] group">
