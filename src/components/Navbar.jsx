...
import {
  ...
  ArrowRight, Zap, Sun, Moon, Megaphone,
SearchCheck  
} from 'lucide-react';
...
const Navbar = ({ isDark, toggleTheme }) => {
  ...
  const services = [
    ...
    { name: "SEO Services", icon: <SearchCheck size={16} />, path: "/seo-services", desc: "Technical SEO, On-Page SEO & Rankings" },
    { name: "Digital Marketing", icon: <Megaphone size={16} />, path: "/digital-marketing", desc: "Social Media, PPC, Content & Online Growth" },
